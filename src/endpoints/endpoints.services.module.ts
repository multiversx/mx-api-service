...
import { ContractsServiceModule } from "./vm.query/contracts/contracts.module";
...
@Module({
  ...
  exports: [
    ...
    ProcessNftsModule, NftMarketplaceModule, TransactionsBatchModule, ContractsServiceModule,
  ],
})
