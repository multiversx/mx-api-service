...
export class NftController {
  ...
  async getNfts(
    ...
    return await this.nftService.getNfts({ from, size }, { search, identifiers, type, collection, name, tags, creator, hasUris, isWhitelistedStorage }, { withOwner, withSupply, withMetadata });
  }
