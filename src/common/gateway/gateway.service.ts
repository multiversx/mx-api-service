...
export class GatewayService {
  ...
  async getTransactionPool(): Promise<TxPoolGatewayResponse> {
    return await this.get(`transaction/pool?fields=hash,nonce,sender,receiver,gaslimit,gasprice,receiverusername,data,value`, GatewayComponentRequest.transactionPool);
  }
