  ...
  static forRoot(): DynamicModule {
    ...
    if (isPassThrough) {
      return {
        ...
        providers: [
          ...
          {
            provide: getRepositoryToken(AccountDetailedDb),
            useValue: {},
          },
          PersistenceService,
        ],
    ...
    return {
      ...
      imports: [
        TypeOrmModule.forRootAsync({
          ...
          useFactory: (apiConfigService: ApiConfigService) => {
            ...
            const options: TypeOrmModuleOptions = {
              type: 'mongodb',
              entities: [NftMetadataDb, NftMediaDb, NftTraitSummaryDb, KeybaseConfirmationDb, HotSwappableSettingDb, AccountDetailedDb],
        ...
        TypeOrmModule.forFeature([NftMetadataDb, NftMediaDb, NftTraitSummaryDb, KeybaseConfirmationDb, HotSwappableSettingDb, AccountDetailedDb]),
      ],
      providers: [PersistenceService],
      exports: [PersistenceService, TypeOrmModule.forFeature([NftMetadataDb, NftMediaDb, NftTraitSummaryDb, KeybaseConfirmationDb, HotSwappableSettingDb, AccountDetailedDb])],
    };
  }
}
