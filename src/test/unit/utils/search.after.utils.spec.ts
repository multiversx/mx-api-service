...
describe('SearchAfterUtils', () => {
  describe('sortKeepingPositions', () => {
    it('keeps every searchAfter on its original position', () => {
      ...
      const sorted = SearchAfterUtils.sortKeepingPositions(items, list => [...list].sort((a, b) => b.rank - a.rank));
    ...
    it('leaves items without searchAfter untouched', () => {
      ...
      const sorted = SearchAfterUtils.sortKeepingPositions(items, list => [...list].sort((a, b) => a.rank - b.rank));
