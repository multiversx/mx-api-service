...
describe("API Testing", () => {
  ...
  describe('/auctions', () => {
    it('should check auctions status response code', async () => {
      const checker = new ApiChecker('auctions', app.getHttpServer());
      await checker.checkStatus();
    });

    it('should check response body for auctions available in marketplaces', async () => {
      const checker = new ApiChecker('auctions', app.getHttpServer());
