import { CachingService, ApiService, Constants } from "@multiversx/sdk-nestjs";
...
describe('UsernameService', () => {
  ...
  describe('getUsernameForAddress', () => {
    it('should return cached username if available', async () => {
      ...
      const cachingServiceSpy = jest.spyOn(service['cachingService'], 'getOrSetCache').mockResolvedValue(cachedUsername);
    ...
    it('should return null if getUsernameForAddressRaw fails', async () => {
      ...
      const cachingServiceSpy = jest.spyOn(service['cachingService'], 'getOrSetCache').mockResolvedValue(null);
    ...
    it('should return null when getUsernameForAddressRaw returns null', async () => {
      ...
      const cachingServiceSpy = jest.spyOn(service['cachingService'], 'getOrSetCache').mockImplementation((_key, func) => func());
  ...
  describe('getAddressForUsername', () => {
    it('should cross-check username when getting address', async () => {
      ...
      const cachingServiceSpy = jest.spyOn(service['cachingService'], 'getOrSetCache').mockResolvedValue(expectedAddress);
