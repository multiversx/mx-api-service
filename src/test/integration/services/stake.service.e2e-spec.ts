...
describe('Stake Service', () => {
  ...
  describe('getGlobalStake', () => {
    it('should return global stake with total staked value', async () => {
      ...
      jest.spyOn(cachingService, 'getOrSetCache').mockImplementationOnce(async () => expected);
    ...
    it('should return cached value', async () => {
      ...
      expect(cachingService.getOrSetCache).toHaveBeenCalledTimes(1);
      expect(cachingService.getOrSetCache).toHaveBeenCalledWith(
  ...
  describe('getValidators', () => {
    it('should return details about validators and return valid results', async () => {
      ...
      expect(result.totalValidators).toEqual(96);
      expect(result.activeValidators).toEqual(95);
