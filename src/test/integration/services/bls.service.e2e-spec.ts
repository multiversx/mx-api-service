...
describe('BlsService', () => {
  ...
  describe('getPublicKeys', () => {
    it('should return an array of public keys', async () => {
      ...
      jest.spyOn(cachingService, 'getOrSetCache').mockResolvedValue(expectedPublicKeys);
    ...
    it('should return public keys for a given shard and epoch', async () => {
      ...
      jest.spyOn(cachingService, 'getOrSetCache').mockImplementation(async (_key, promise) => await promise());
